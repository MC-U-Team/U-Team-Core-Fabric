...
public class ExtendedButton extends Button
{
    ...
    public void renderButton(PoseStack poseStack, int mouseX, int mouseY, float partialTick)
    {
        ...
        RenderUtil.drawContinuousTexturedBox(poseStack, this.x, this.y, 0, 46 + k * 20, this.width, this.height, 200, 20, 2, 3, 2, 2, this.getBlitOffset(), WIDGETS_LOCATION, RGBA.WHITE);
        ...
        drawCenteredString(poseStack, mc.font, buttonText, this.x + this.width / 2, this.y + (this.height - 8) / 2, 0xFFFFFFFF);
    }
}

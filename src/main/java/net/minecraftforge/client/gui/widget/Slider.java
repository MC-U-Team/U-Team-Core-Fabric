...
public class Slider extends ExtendedButton
{
    ...
    protected void renderBg(PoseStack poseStack, Minecraft minecraft, int par2, int par3)
    {
        if (this.visible)
        {
            ...
            RenderUtil.drawContinuousTexturedBox(poseStack, this.x + (int)(this.sliderValue * (float)(this.width - 8)), this.y, 0, 66, 8, this.height, 200, 20, 2, 3, 2, 2, this.getBlitOffset(), WIDGETS_LOCATION, RGBA.WHITE);
        }
    }
